...
def c1():
  ...
  try:
    ...
    print("\n\nERROR 0x01:"+color.RED+" FadLan gaLi number\n\n"+color.END)
    exit()
  if choice > 4 or choice < 1:
    print("\n\nEERROR 0x02:"+color.RED+" FadLan gaLi number u dhexeya 1-4\n\n"+color.END)
    exit()

  return choice

def vpn_error():
  print("\n\nERROR 0x03: "+color.RED+"Vpn-ku ma awoodo inu ku dhex furmo windows-ka\n\n"+color.END)
  exit()
...
def c_vpn():
  ...
  try:
    ...
    print("\n\nERROR 0x02:"+color.RED+" FadLan gaLi number udhexeeya 0-1\n\n"+color.END)
    exit()
  if choice > 1 or choice < 0:
    print("\n\nERROR 0x02:"+color.RED+" FadLan gaLi number u dhexeeya 0-1\n\n"+color.END)
    exit()
...
def start_instagram():
  ...
  try:
    ...
    print("\n\nERROR 0x02:"+color.RED+" FadLan gaLi number\n\n"+color.END)
    exit()
  if choice > 3 or choice < 1:
    print("\n\nEERROR 0x01:"+color.RED+"  FadLan gaLi number udhexeeya 1-3\n\n"+color.END)
    exit()
...
def insta_bruteforce(username, wordlist, vpn):
  ...
  try:
      ...
      print("\n\nEERROR 1x01:"+color.RED+" Wordlist-gan Lama heLi karo,FadLan iskuday Wordlist-ga saxda ah inaad gaLiso!\n\n"+color.END)
      exit()  
...
def get_amount():
  ...
  try:
    ...
    print("\n\nERROR 2x00:"+color.RED+" FadLan gaLi number\n\n"+color.END)
    exit()
  return amount
...
facebook_ju  = '''
qaLabka phishing ee Fb waa La Horumarinayaa! Waxaan hadda ka shaqaynaynaa hirgelinta hawshaas waxadna kaLa socon karta: "https://github.com/Edhacking/"
Haddii aad jeceshahay inaad wax ku darsato, fadlan xor u tahay inaad nala so wadaagto. Waad ku mahadsan tahay dulqaadkaaga iyo fahamkaaga! 
'''
twitter_ju  = '''
qaLabka phishing ee twitter waa La Horumarinayaa! Waxaan hadda ka shaqaynaynaa hirgelinta hawshaas waxadna kaLa socon karta: "https://github.com/Edhacking/"
 Haddii aad jeclaan lahayd inaad wax ku darsato, fadlan xor ayaad u tahay inaad nala so wadaagto. Waad ku mahadsan tahay dulqaadkaaga iyo fahamkaaga! 
'''

gmail_ju  = '''
 qaLabka phishing ee Gmail waa LaHorumarinayaa! Waxaan hadda ku hawlanahay hirgelinta hawshaas waxadna kaLa socon karta: "https://github.com/Edhacking/"
...
Qalabka phishing waa la horumarinayaa! Waxaan hadda ka shaqeyneynaa hirgelinta koodhka phishing-ka ee soo socda: "https://github.com/Edhacking/"
 Haddii aad jeclaan lahayd inaad wax ku darsato, fadlan xor ayaad u tahay inaad nala so wadaagto. Waad ku mahadsan tahay dulqaadkaaga iyo fahamkaaga! 
'''
